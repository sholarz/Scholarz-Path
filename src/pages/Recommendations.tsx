  ...
  if (!profile?.gpa || !profile?.field) {
    return (
      <div className="max-w-md mx-auto py-20 text-center bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <h2 className="text-2xl font-bold text-slate-900">Lengkapi Profil</h2>
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 uppercase italic">Smart Matching</h1>
        ...
        <Button onClick={handleRunMatching} disabled={matching} size="lg" className="bg-indigo-600 text-white hover:bg-indigo-700 shadow-xl shadow-indigo-100 rounded-xl px-8 font-bold">
      ...
      {matches.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center bg-white rounded-[40px] border border-slate-100 shadow-sm">
          ...
          <h3 className="text-2xl font-bold text-slate-900 tracking-tight">Siap Untuk Sukses?</h3>
