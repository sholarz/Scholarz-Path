        ...
        <Card className="w-full max-w-md rounded-[32px] border-slate-100 shadow-xl overflow-hidden">
          ...
          <CardContent className="px-8 pb-8 space-y-4">
            <p className="text-sm text-center text-slate-600 leading-relaxed">
              Tolong cek folder inbox atau spam Anda. Anda perlu memverifikasi email sebelum dapat mengakses fitur lengkap ScholarPath.
            </p>
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 text-xs font-medium text-slate-500">
               Belum menerima email? Tunggu beberapa menit atau klik tombol di bawah untuk kirim ulang.
            </div>
          </CardContent>
          <CardFooter className="px-8 pb-10 flex flex-col gap-3">
             <Button 
                variant="outline" 
                className="w-full rounded-xl border-slate-200 h-11 font-bold bg-slate-900 text-white hover:bg-slate-800"
             ...
             <Button 
                variant="ghost" 
                className="w-full rounded-xl text-slate-900 font-bold hover:bg-slate-50"
             ...
             <Button 
                variant="ghost" 
                className="w-full rounded-xl text-slate-400 font-bold hover:text-slate-900"
                onClick={() => navigate('/')}
             >
                Kembali ke Beranda
             </Button>
          ...
          <CardContent className="p-8">
            {isForgotPassword ? (
              <form onSubmit={handleResetPassword} className="space-y-4">
                ...
                {isEmailSent ? (
                  ...
                  <Button 
                    type="submit" 
                    className="w-full h-11 rounded-xl bg-slate-900 text-white font-bold hover:bg-slate-800 transition-all shadow-lg shadow-slate-200"
                    disabled={loading}
                  >
              ...
              <Tabs defaultValue="login" className="w-full">
                <TabsList className="grid w-full grid-cols-2 rounded-xl bg-slate-100 p-1 mb-8">
                  <TabsTrigger value="login" className="rounded-lg font-bold text-xs data-[state=active]:bg-white data-[state=active]:shadow-sm">LOGIN</TabsTrigger>
                  <TabsTrigger value="register" className="rounded-lg font-bold text-xs data-[state=active]:bg-white data-[state=active]:shadow-sm">REGISTER</TabsTrigger>
                </TabsList>
            ...
            {!isForgotPassword && (
              <>
                ...
                <Button 
                  variant="outline" 
                  className="w-full h-11 rounded-xl border-slate-200 font-bold hover:bg-slate-50 transition-all flex items-center justify-center gap-3"
