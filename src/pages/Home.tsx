...
import { GraduationCap, ArrowRight, Sparkles, Calendar, Clock, Globe, Search, Bookmark, CheckCircle2 } from "lucide-react";
        ...
        <div className="container relative mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <p className="mx-auto mt-8 max-w-2xl text-lg text-slate-500 leading-relaxed">
              ScholarzPath menggunakan AI untuk mencocokkan Anda dengan beasiswa terbaik di Indonesia. Mulai sekarang dan pantau setiap langkah pendaftaran Anda dengan mudah.
            </p>
      ...
      <section className="bg-slate-50/50 py-24 border-y border-slate-100">
        <div className="container mx-auto px-4">
          <div className="mb-20 text-center max-w-3xl mx-auto">
            ...
            <p className="mt-4 text-slate-500 font-medium">ScholarzPath provides all the tools you need to find, track, and apply for scholarships efficiently.</p>
          </div>
