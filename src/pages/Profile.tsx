  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight italic">Lengkapi Profil</h1>
        ...
        <Card className="border-slate-100 shadow-sm overflow-hidden">
          ...
          <CardContent className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="gpa" type="number" step="0.01" placeholder="Contoh: 3.75" value={formData.gpa} onChange={(e) => setFormData({ ...formData, gpa: e.target.value })} className="rounded-xl border-slate-200 focus:ring-slate-900" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="field" placeholder="Contoh: Computer Science" value={formData.field} onChange={(e) => setFormData({ ...formData, field: e.target.value })} className="rounded-xl border-slate-200 focus:ring-slate-900" />
            </div>
          </CardContent>
        </Card>
