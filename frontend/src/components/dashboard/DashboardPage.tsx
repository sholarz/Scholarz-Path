...
import {
    getTestHistory,
    type TestHistorySummary,
} from "../../lib/test-prep-api";
...
export function DashboardPage() {
    ...
    const [testSummary, setTestSummary] = useState<TestHistorySummary | null>(
        null,
    );
    ...
    useEffect(() => {
        ...
        const loadDashboardData = async () => {
            ...
            try {
                const [testPayload, dashboardPayload, bookmarksPayload] =
                    await Promise.all([
                        getTestHistory(),
                        getDashboardData(),
                        getBookmarks(),
    ...
    if (error) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-background">
                <Card className="w-96 border-red-200 bg-red-50/50">
    ...
    ).filter((item) => item.daysUntilDeadline <= 7);
    ...
    const stats = [
        ...
        },
        {
            title: "Bookmarked",
            value: bookmarkLimit
                ? `${displayedBookmarkCount}/${bookmarkLimit}`
                : displayedBookmarkCount,
            icon: Bookmark,
            color: "text-purple-600",
            bgColor: "bg-purple-100",
            subtitle:
                bookmarkLimit && !canAddMore ? "Limit reached" : undefined,
        },
        {
                        ...
                        <Card className="border-yellow-200 bg-yellow-50/50">
                            ...
                            <CardContent>
                                <p className="text-sm text-yellow-700 mb-3">
                                    {approachingDeadlines.length} bookmarked
                                    scholarship
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-blue-700">
                                        You have full admin access to all
                                        features and scholarship management
                                        capabilities.
                                    </p>
                                </div>
                            </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-yellow-700 mb-2">
                                            Get unlimited bookmarks, automated
                                            preparation timeline, and more!
                                        </p>
                        ...
                        {!testSummary || testSummary.total_attempts === 0 ? (
                            ...
                            <div className="grid md:grid-cols-4 gap-4">
                                ...
                                <div className="rounded-lg border p-3">
                                    ...
                                    <p className="text-2xl font-bold">
                                        {testSummary.last_score ?? "-"}
                                        {testSummary.last_score !== null
                                            ? "%"
                                            : ""}
                                    </p>
                                </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            0 ? (
                                ...
                                (dashboardData?.upcomingDeadlines ?? []).map(
                                    (deadline) => (
                                        <Link
                                            key={deadline.scholarshipId}
                                            to={`/scholarships/${deadline.scholarshipId}`}
                            ...
                            {bookmarkedScholarships.length === 0 ? (
                                <div className="text-center py-8">
                                    <p className="text-sm text-muted-foreground mb-4">
                                        You haven't bookmarked any scholarships
                                        yet
                                    </p>
                    ...
                    <CardContent className="pt-6">
                        <div className="grid md:grid-cols-3 gap-4">
                            <Link to="/scholarships">
                                <Button
                                    variant="outline"
                                    className="w-full h-full justify-start gap-3 p-4"
                                >
                            ...
                            <Link to="/timeline">
                                <Button
                                    variant="outline"
                                    className="w-full h-full justify-start gap-3 p-4 relative"
                                >
                                    {user?.role === "free" && (
